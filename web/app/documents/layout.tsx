...
// Mirrors app/(admin)/admin/exam/packages/[id]/layout.tsx (the certificate
// editor's font set) so a field rendered here in a given font matches the
// editor pixel-for-pixel (FR-25).
...
export default function DocumentsLayout({ children }: { children: React.ReactNode }) {
  return (
    <div
      className={`${publicSans.variable} ${sourceSerif.variable} ${cinzel.variable} ${playfairDisplay.variable} ${cormorantGaramond.variable} ${greatVibes.variable} ${poppins.variable} ${libreBaskerville.variable} ${allura.variable} ${parisienne.variable}`}
    >
      {children}
    </div>
  );
